...
namespace DoozyUI
{
    ...
    public class UIElement : MonoBehaviour
    {
        ...
        private Hunter.AbstractPanel _maybePanel;
        public void Reset()
        {
        ...
        void Awake()
        {
            ...
            _maybePanel = gameObject.GetComponent<Hunter.AbstractPanel>();
        ...
        void ToggleCanvasAndGraphicRaycaster(bool isEnabled)
        {
            ...
            if (!disableGraphicRaycaster)
            {
                ...
                if (_maybePanel != null)
                {
                    bool isPanelMask = Hunter.UIMgr.S.topPanelHideMask == Hunter.PanelHideMask.UnInteractive
                                        || _maybePanel.hideMask == Hunter.PanelHideMask.UnInteractive;
