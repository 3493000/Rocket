...
namespace Hunter
{
    ...
    {
        public static void LoadSpinAnimSkeleton(Spine.Unity.SkeletonAnimation anim, Hunter.ResLoader loader, string asset)
        {
        ...
        //public static Sprite FindSprite(Hunter.ResLoader loader, string assetName, string spriteName)
        //{
        //    Sprite result = null;
        //    result = loader.LoadSync(spriteName) as Sprite;
        //    if (result == null)
        //    {
        //        var data = loader.LoadSync(assetName) as Hunter.SpritesData;
        //        if (data != null)
        //        {
        //            GameplayMgr.S.GameSprHandler.SetData(new Hunter.SpritesData[] { data });
        ...
        public static string Second2NormalTime(long time)
        {
            string m_Time = "";
            long Left;
            long Hour;
            ...
            {
                Hour = 12;
                return string.Format("12 hours", Hour.ToString("00"));
            }
            time = time % 3600;
            ...
            m_Time = string.Format("{0};{1}:{2}", Hour.ToString("00"), Min.ToString("00"), Second.ToString("00"));
            if (Hour > 0)
            {
                return Hour + "hours";
            }
        ...
        public static string Second2NormalTimeDetial(long time)
        {
            string m_Time = "";
            long Left;
            long Hour;
            ...
            if (Second > 0)
            {
                m_Time = string.Format("{0}s",Second.ToString("00"));
            }

            if (Min > 0)
            {
                m_Time = string.Format("{0}:{1}", Min.ToString("00"), Second.ToString("00"));
            }
